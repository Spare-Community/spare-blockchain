...
DMG_NAME="Spare-$CHIA_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
NODE_PATH=./npm_macos_m1/node_modules node build_dmg.js dist/Spare-darwin-arm64/Spare.app $CHIA_INSTALLER_VERSION-arm64
LAST_EXIT_CODE=$?
if [ "$LAST_EXIT_CODE" -ne 0 ]; then
...
if [ "$NOTARIZE" ]; then
  ...
  notarize-cli --file=$DMG_NAME --bundle-id net.spare.blockchain \
...
# xcrun altool --notarize-app -f Spare-0.1.X.dmg --primary-bundle-id net.spare.blockchain -u username -p password
